...
public class ApplicationRoot {
  ...
  private static MutablePicoContainer createContainer() {
    ...
    context.as(CACHE)
        ...
        .addComponent(Inbound.class, BinaryUdpInbound.class)
        // forgot about this... context.addComponent(Marshalling.class, XmlMarshalling.class);
        .addComponent(SqlDataDestination.class);
    context.as(NO_CACHE)
        .addComponent(OutboundMessage.class, XmlOutboundMessage.class)
