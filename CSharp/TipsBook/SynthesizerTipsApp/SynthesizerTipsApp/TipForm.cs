...
namespace SynthesizerTipsApp
{
    public class TipForm : Form
    {
        ...
        private readonly int tipNumber;
        private readonly int totalTips;
        ...
        private void InitializeUi()
        {
            ...
            var exampleIndex = tipText.IndexOf("Example:", StringComparison.OrdinalIgnoreCase);
            if (exampleIndex > 0)
            {
                tipTitle = tipText[..exampleIndex].Trim();
                example = tipText[exampleIndex..].Trim();
            }
